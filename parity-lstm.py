...
y = keras.layers.LSTM(latent_dim,activation='tanh',
...
epochs = 1000
history = coupled.fit([encX,decX], decY, validation_split=0.2,epochs=epochs,verbose=1)
...
predictions = postNTF
out=MaskedSparseCategoricalAccuracy(decY1,predictions)
print(out.numpy())